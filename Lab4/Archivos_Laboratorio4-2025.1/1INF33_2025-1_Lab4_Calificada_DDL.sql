...
-- 1INF33_2025-1_Lab2_Calificada_DDL
-- Elaborado por PVC, MFS, IVC
-- basado y adaptado de DDL del lab 1 elaborados por LOW y ACB
...
CREATE TABLE AP_CARGOS (
    ...
    DETALLE_CARGO VARCHAR2(50 BYTE) NOT NULL,
...
COMMENT ON COLUMN AP_CARGOS.DETALLE_CARGO IS
    'Puede ser:
- Piloto (a)
- Copiloto (a)
- Jefe (a) de cabina
...
CREATE TABLE AP_CIUDADES (
    CIUDAD_ID NUMBER NOT NULL,
    NOMBRE_CIUDAD    VARCHAR2(30 BYTE) NOT NULL,
...
COMMENT ON COLUMN AP_CIUDADES.NOMBRE_CIUDAD IS
    'NOMBRE de la ciudad';
...
NRO_DOCUMENTO VARCHAR2(12) NOT NULL ,
...
CONSTRAINT PK_EMPLEADOS PRIMARY KEY (EMPLEADO_ID),
 CONSTRAINT FK_EMPLEADOS_CARGOS FOREIGN KEY (CARGO_ID)
 REFERENCES AP_CARGOS (CARGO_ID)
 )
;

COMMENT ON COLUMN AP_EMPLEADOS.EMPLEADO_ID IS
 'Codigo identificador del empleado';
...
COMMENT ON COLUMN AP_EMPLEADOS.NRO_DOCUMENTO IS
 'Número de documento del empleado puede tener 8 caracteres si es DNI o 12 si es
Carnet de extranjería';
COMMENT ON COLUMN AP_EMPLEADOS.NOMBRES IS
